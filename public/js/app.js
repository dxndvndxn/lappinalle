...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    $route: function $route() {
      console.log(1); //this.$store.dispatch('MakeCrumbs', this.$route.params);
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    categNdepartsMenu: function categNdepartsMenu() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "crumbs" }, [
    _vm._v(
      "\n        " +
        _vm._s(_vm.$route.params.gender) +
        "\n        " +
  ...
  return _c("div", [
    _c(
      ...
      [
        _c("Breadcrumbs", {
          attrs: {
            genderMenu: _vm.genderMenu,
            catNdepart: _vm.categNdepartsMenu
          }
        })
      ],
      1
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    ...
    getMenuDataMutate: function getMenuDataMutate(state) {
      state.topMenu = [];
      state.lastMenu = {};
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/menu').then(function (response) {
        ...
        var gendersObj = {}; // Определяем гендеры в разных массивах, объектаъ
