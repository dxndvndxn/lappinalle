    ...
    <div class="catalog-item container" v-if="returnDataForItem !== null">
        ...
        <div class="item-info">
            <div class="item-pics" ref="itemImgs">
                <div class="wrap">
                    <div class="item-pic" v-for="(img, i) in returnDataForItem.itemPics" :key="i">
            ...
            <div class="item-main-pic">
                ...
                <img :src="returnDataForItem.itemPics[mainPic].img" calt="">
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            addToCart(itemId, itemPrice){
                this.$store.commit('addToCart',{ id: itemId, price: itemPrice});
            }
        },
        computed: {
