    ...
    <div class="catalog-item container" v-if="returnDataForItem !== null && returnDataForItem !== undefined">
        ...
        <div class="item-info">
            ...
            <div class="item-main-pic" v-if="media.wind > media.tablet">
                ...
                <img :src="returnDataForItem.itemPics[mainPic].img" v-if="returnDataForItem.itemPics[mainPic].video === false || mainPic > 0">
            </div>
            ...
            <div class="item-main-info">
                <div class="item-main-wrap">
                    ...
                    <div class="item-main-sizes">
                        ...
                        <button v-for="(size, s) in returnDataForItem.itemSizes" @click="chozenSize(s, size.sz)" v-bind:class="size.active ? 'active-size' : null">
                            {{size.sz}}
                        </button>
                    ...
                    if (this.clickedSize !== null) {
                        ...
                        this.clickedSize.forEach(el => {
                            ...
                            if (findSizeWithNoSale){
                                data.push({id: itemId, count: 1, size: el.sz, price: oldPrice});
                            } else {
