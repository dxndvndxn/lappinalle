                ...
                <div class="card" v-for="(card, c) in getProductCart">
                    ...
                    <div class="card-info">
                        ...
                        <div class="card-counts">
                            ...
                            <div class="card-price">Цена: <span>{{card.count * +card.product_price}} &#8381;</span></div>
                        </div>
                        <div class="card-desc">
                    ...
                    <div class="card-close">
                        <span class="close-btn" @click="removeCard(card.id, card.size, card.count)"></span>
                    </div>
                </div>
            </div>
...
<!--        <div class="cart-no bookmark-text" v-if="getProductCart == null || getProductCart.length === 0">-->
        <div class="cart-no bookmark-text" v-else>
    ...
    export default {
        ...
        methods:{
            countTotal(arr){
                this.totalPrice = 0;
                arr.forEach((val) => {
                    this.totalPrice += +val.product_price * val.count;
                })
            },
            itemPlus(i, id, size){
