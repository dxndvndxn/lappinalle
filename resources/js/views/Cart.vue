<template>
    <div class="cart container">
        ...
        <div class="cart-total">
            ...
            <button class="classic-btn-sz btn">Оформить заказ</button>
        </div>
    </div>
</template>
